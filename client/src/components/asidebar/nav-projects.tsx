...
export function NavProjects() {
  ...
  return (
    <>
      <SidebarGroup className="group-data-[collapsible=icon]:hidden md:group-data-[collapsible=icon]:block">
        ...
        <SidebarMenu className="h-[200px] sm:h-[280px] md:h-[320px] scrollbar overflow-y-auto pb-2">
